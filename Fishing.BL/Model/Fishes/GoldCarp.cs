...
namespace Fishing.BL.Model.Fishes {
    ...
    internal class GoldCarp : Fish {
        ...
        public GoldCarp(int minD, int maxD, double maxSizeCoef, HashSet<FishBait> lu) : base(name, randomWeight.Next(50, Convert.ToInt32(3000 * maxSizeCoef)), Power.SetPower(6, 2), price, trophyWeight, activParts, description, bit) {
            MinDeep = minD;
            MaxDeep = maxD;
